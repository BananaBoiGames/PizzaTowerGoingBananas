...
if (!((obj_player.state == (24 << 0) && obj_player.state == (25 << 0) && obj_player.state == (18 << 0))))
    once = 0
...
else if (global.hurtcounter >= global.hurtmilestone && obj_player.character == "P")
{
    ...
    if (tvsprite != 916 && tvsprite != 915 && tvsprite != 914 && tvsprite != 913)
        tvsprite = choose(916, 915, 914, 913)
    global.hurtmilestone += 3
}
else if (obj_player.state == (44 << 0))
{
    showtext = 1
    message = "SWEET DUDE!!"
    alarm[0] = 50
