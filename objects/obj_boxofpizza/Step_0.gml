with (obj_player)
{
    ...
    {
        if (((key_down && (!(place_meeting(x, (y + 1), obj_destructibles))) && place_meeting(x, (y + 1), other.id) && (state == (66 << 0) || character == "S" || state == (37 << 0))) || ((state == (68 << 0) || state == (74 << 0) || state == (77 << 0)) && (!(place_meeting(x, (y + 1), obj_destructibles))) && place_meeting(x, (y + 1), other.id))) && (!instance_exists(obj_fadeout)) && state != (78 << 0) && state != (61 << 0) && ((obj_player1.spotlight == 1 && object_index == obj_player1) || (obj_player1.spotlight == 0 && object_index == obj_player2)))
        {
            other.depth = -10
    ...
    if (other.image_yscale == -1)
    {
        if (((key_up && (!(place_meeting(x, (y - 1), obj_destructibles))) && place_meeting(x, (y - 1), other.id) && (state == (0 << 0) || state == (58 << 0) || state == (69 << 0) || state == (70 << 0) || state == (90 << 0) || state == (65 << 0))) || ((state == (63 << 0) || state == (92 << 0)) && (!(place_meeting(x, (y - 1), obj_destructibles))) && place_meeting(x, (y - 1), other.id))) && (!instance_exists(obj_fadeout)) && state != (78 << 0) && state != (61 << 0) && ((obj_player1.spotlight == 1 && object_index == obj_player1) || (obj_player1.spotlight == 0 && object_index == obj_player2)))
        {
            scr_soundeffect(sfx_box)
            other.depth = -10
            obj_player1.box = 1
