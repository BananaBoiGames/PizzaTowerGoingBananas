with (obj_player1)
{
    if (key_up && grounded && (state == 0 || state == 69 || state == 70 || state == 90) && (!instance_exists(obj_noisesatellite)) && (!instance_exists(obj_fadeout)) && state != 64 && state != 61 && obj_player1.spotlight == 1)
    {
        audio_stop_all()
        backtohubstartx = x
        backtohubstarty = y
...
with (obj_player2)
{
    if (key_up && grounded && (state == 0 || state == 69 || state == 70 || state == 90) && (!instance_exists(obj_noisesatellite)) && (!instance_exists(obj_fadeout)) && state != 64 && state != 61 && obj_player1.spotlight == 0)
    {
        audio_stop_all()
        backtohubstartx = x
        backtohubstarty = y
