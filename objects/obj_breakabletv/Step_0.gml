...
if (grabbed == 1)
{
    ...
    if (obj_player.state == (28 << 0) || obj_player.state == (46 << 0) || obj_player.state == (41 << 0) || obj_player.state == (42 << 0) || obj_player.state == (10 << 0))
    {
        grounded = 0
        x = obj_player.x
    ...
    with (obj_player)
    {
        ...
        if (!((state == (46 << 0) || state == (28 << 0) || state == (41 << 0) || state == (42 << 0) || state == (10 << 0) || state == (47 << 0) || state == (43 << 0) || state == (48 << 0) || state == (49 << 0) || state == (50 << 0))))
        {
            other.x = x
            other.y = y
            other.grabbed = 0
