with (obj_player)
{
    if (grounded && x > (other.x - 160) && x < (other.x + 160) && key_up && (state == 0 || state == 69 || state == 70 || state == 90) && (global.panic == 1 || global.snickchallenge == 1))
    {
        targetDoor = "none"
        ...
        if (string_letters(roomname) == "mario")
        {
            ini_open("saveData.ini")
            if (global.secretfound > global.ruinsecret)
                ini_write_string("Secret", "mario", global.secretfound)
            if (global.ruintreasure == 0)
                ini_write_string("Treasure", "mario", global.treasure)
            if (global.ruinhighscore < global.collect)
                ini_write_string("Highscore", "mario", global.collect)
            if (global.ruinhighscore < global.collect)
                ini_write_string("Highscore", "mario", global.collect)
            if (global.ruintoppin1 != 1)
                ini_write_string("Toppin", "mario1", global.shroomfollow)
            if (global.ruintoppin2 != 1)
                ini_write_string("Toppin", "mario2", global.cheesefollow)
            if (global.ruintoppin3 != 1)
                ini_write_string("Toppin", "mario3", global.tomatofollow)
            if (global.ruintoppin4 != 1)
                ini_write_string("Toppin", "mario4", global.sausagefollow)
            if (global.ruintoppin5 != 1)
                ini_write_string("Toppin", "mario5", global.pineapplefollow)
            if (global.rank == "s")
                ini_write_string("Ranks", "mario", global.rank)
            if (global.rank == "a" && "s" != ini_read_string("Ranks", "mario", "none"))
                ini_write_string("Ranks", "mario", global.rank)
            if (global.rank == "b" && "s" != ini_read_string("Ranks", "mario", "none") && "a" != ini_read_string("Ranks", "ruin", "none"))
                ini_write_string("Ranks", "mario", global.rank)
            if (global.rank == "c" && "s" != ini_read_string("Ranks", "mario", "none") && "a" != ini_read_string("Ranks", "ruin", "none") && "b" != ini_read_string("Ranks", "ruin", "none"))
                ini_write_string("Ranks", "mario", global.rank)
            if (global.rank == "d" && "s" != ini_read_string("Ranks", "mario", "none") && "a" != ini_read_string("Ranks", "ruin", "none") && "b" != ini_read_string("Ranks", "ruin", "none") && "c" != ini_read_string("Ranks", "ruin", "none"))
                ini_write_string("Ranks", "mario", global.rank)
			ini_close()
