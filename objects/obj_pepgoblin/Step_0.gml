...
if (bombreset > 0)
    bombreset--
if (x != obj_player1.x && state != (97 << 0) && obj_player.state != (2 << 0) && bombreset == 0 && grounded)
{
...
if instance_exists(obj_player2)
{
    if (x != obj_player2.x && state != (97 << 0) && bombreset == 0 && grounded)
    {
...
if (grounded && state == (97 << 0) && floor(image_index) == 3)
    vsp = -5
if (boundbox == 0)
{
