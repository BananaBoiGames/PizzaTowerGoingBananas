...
if (angry == 1 && (!instance_exists(chargeeffectid)) && state == 0)
{
...
if (inv_frames == 0 && hurted == 0)
    image_alpha = 1
if (state == 70 || state == 10 || state == 44 || state == 24 || state == 15 || state == 13 || state == 18 || state == 25 || state == 27 || state == 34 || state == 40 || state == 34 || state == 37 || state == 90 || state == 74 || state == 63)
    attacking = 1
else
    attacking = 0
if (state == 41 || state == 47 || state == 48 || state == 50 || state == 49)
    ...
    grabbing = 0
if (state == 90 || state == 60 || (state == 73 && thrown == 1) || state == 70 || state == 17 || state == 74 || state == 2 || state == 6 || state == 7 || state == 9 || state == 44 || state == 35 || state == 63 || state == 37 || state == 40 || state == 10 || (state == 43 && sprite_index == spr_piledriver) || state == 24 || state == 25 || state == 18 || state == 15 || state == 13 || state == 11)
    instakillmove = 1
else
    instakillmove = 0
if (flash == 1 && alarm[0] <= 0)
    alarm[0] = (0.15 * room_speed)
if (state != 90 && state != 71)
    autodash = 0
...
if (state != 69 && state != 58 && state != 9 && state != 22 && state != 0 && state != 70 && state != 90 && state != 91 && state != 24 && state != 38 && state != 18)
    momemtum = 0
...
if (state != 58)
    stompAnim = 0
if ((state == 90 || (state == 109 && instance_exists(obj_player2) && obj_player2.state == 90) || state == 70 || state == 17 || state == 9 || state == 37 || state == 10 || state == 22 || state == 71) && macheffect == 0)
{
    macheffect = 1
    toomuchalarm1 = 6
...
if (!((state == 90 || (state == 109 && instance_exists(obj_player2) && obj_player2.state == 90) || state == 70 || state == 17 || state == 9 || state == 37 || state == 10 || state == 22 || state == 71)))
    macheffect = 0
if (toomuchalarm1 > 0)
{
    toomuchalarm1 -= 1
    if (toomuchalarm1 <= 0 && (state == 90 || (state == 109 && instance_exists(obj_player2) && obj_player2.state == 90) || state == 17 || state == 9 || state == 70 || state == 10 || state == 71 || state == 37 || state == 22 || (state == 33 && mach2 >= 100)))
    {
        with (instance_create(x, y, obj_mach3effect))
        {
            playerid = other.object_index
...
if (state == 23 || sprite_index == spr_knightpepstart || sprite_index == spr_knightpepthunder || state == 56 || state == 78 || state == 4 || state == 64 || state == 61 || state == 55)
    ...
    cutscene = 0
if ((place_meeting(x, y, obj_door) || place_meeting(x, y, obj_dresser) || place_meeting(x, y, obj_snick) || place_meeting(x, y, obj_keydoor) || (place_meeting(x, y, obj_exitgate) && global.panic == 1)) && (!instance_exists(obj_uparrow)) && scr_solid(x, (y + 1)) && state == 0 && obj_player1.spotlight == 1)
{
    with (instance_create(x, y, obj_uparrow))
        playerid = other.object_index
}
if (state == 70 && (!instance_exists(chargeeffectid)))
{
