function scr_collide_destructibles()
{
	with (obj_player1)
	{
	    if (state == (70 << 0) || state == (90 << 0) || state == (37 << 0) || state == (18 << 0) || state == (2 << 0) || state == (9 << 0))
	    {
	    ...
	    if ((state == (24 << 0) || state == (43 << 0) || state == (9 << 0)) && vsp > 0)
	    {
	    ...
	    if (vsp <= 0.5 && (state == (58 << 0) || state == (17 << 0) || state == (6 << 0) || state == (63 << 0) || state == (70 << 0) || state == (90 << 0)))
	    {
	        if place_meeting(x, (y - 1), obj_destructibles)
	        {
	            with (instance_place(x, (y - 1), obj_destructibles))
	            {
	                ...
	                with (other.id)
	                {
	                    if (state != (63 << 0) && state != (17 << 0))
	                        vsp = 0
	                }
	            }
	        }
	    }
	    if (vsp >= 0 && (state == (74 << 0) || state == (77 << 0)))
	    {
