function scr_player_grabbed()
{
	switch object_index
	{
	    case obj_player2:
	        ...
	        if (obj_player1.state == (90 << 0) && fightball == 1)
	        {
	            x = obj_player1.x
	            y = obj_player1.y
	        }
	        if (obj_player1.state == (28 << 0) || obj_player1.state == (46 << 0) || obj_player1.state == (41 << 0) || obj_player1.state == (42 << 0) || obj_player1.state == (10 << 0))
	        {
	            x = obj_player1.x
	        ...
	        with (obj_player1)
	        {
	            ...
	            if (!((state == (46 << 0) || (state == (90 << 0) && fightball == 1) || state == (3 << 0) || state == (28 << 0) || state == (41 << 0) || state == (42 << 0) || state == (10 << 0) || state == (47 << 0) || state == (43 << 0) || state == (48 << 0) || state == (49 << 0) || state == (50 << 0))))
	            {
	                other.x = x
	                other.y = y
	                other.state = (73 << 0)
	        ...
	        if (obj_player1.state == (43 << 0) && obj_player1.sprite_index == obj_player1.spr_piledriver)
	        {
	        ...
	        if (obj_player1.state == (46 << 0) && obj_player1.sprite_index == obj_player1.spr_swingding)
	        {
	            if (floor(obj_player1.image_index) == 0)
	            {
	    ...
	    case 3:
	        ...
	        if (obj_player2.state == (90 << 0) && fightball == 1)
	        {
	            x = obj_player2.x
	            y = obj_player2.y
	        }
	        if (obj_player2.state == (28 << 0) || obj_player2.state == (46 << 0) || obj_player2.state == (41 << 0) || obj_player2.state == (42 << 0) || obj_player2.state == (10 << 0))
	        {
	            x = obj_player2.x
	        ...
	        if (obj_player2.state == (43 << 0) && obj_player2.sprite_index == obj_player2.spr_piledriver)
	        {
	        ...
	        if (obj_player2.state == (46 << 0) && obj_player2.sprite_index == obj_player2.spr_swingding)
	        {
	            if (floor(obj_player2.image_index) == 0)
	            {
	                depth = -8
