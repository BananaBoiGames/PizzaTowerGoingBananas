function scr_enemy_grabbed()
{
	if (grabbedby == 1)
	{
	    ...
	    with (obj_player1)
	    {
	        ...
	        if (!((state == (46 << 0) || state == (3 << 0) || state == (28 << 0) || state == (41 << 0) || state == (42 << 0) || state == (10 << 0) || state == (47 << 0) || state == (43 << 0) || state == (48 << 0) || state == (49 << 0) || state == (50 << 0))))
	        {
	            other.x = x
	            other.y = y
	            other.state = (106 << 0)
